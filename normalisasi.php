...
while ($dt2 = $sql->fetch_array()) {
		echo "<tr>
			...
			<td align='center'>".$dt2["nama"]."</td>
			<td align='center'>".round($dt2['postur_tubuh']/$max['maxK1'],2)."</td>
			<td align='center'>".round($dt2['kelas']/$max['maxK2'],2)."</td>
			<td align='center'>".round($dt2['kedisiplinan']/$max['maxK3'],2)."</td>
			<td align='center'>".round($dt2['mental']/$max['maxK4'],2)."</td>
			<td align='center'>".round($dt2['mimik_wajah']/$max['maxK5'],2)."</td>
		</tr>";
	$no++;
	}
	echo "</table>";
	?>
 					...
 					<a href="proses.php" class="btn btn-secondary">Proses</a>
 				</div>
 			</div>
 		</div>
 	</div>
